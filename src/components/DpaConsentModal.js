    ...
    >
      ...
      <DialogContent dividers>
        <Typography variant="body1" paragraph id="dpa-consent-description">
          Before using Tally Reading with student data, your school must accept the Data Processing
          Agreement (DPA). This agreement outlines how we process personal data in compliance with
          UK GDPR.
        </Typography>
